...
///  thor::AnimationMap. On the other side, you must make sure the original animation stays alive while being referenced.
/// @n@n Example:
/// @code
///  // Create animation
...
#include <lib/thor/include/Thor/Animations/Detail/RefAnimation.inl>
