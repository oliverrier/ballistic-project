...
float toiTime, toiMaxTime;
int toiCalls, toiIters, toiMaxIters;
int toiRootIters, toiMaxRootIters;
...
void TimeOfImpact(TimeOfImpactOutput* output, const TimeOfImpactInput* input)
{
	Timer timer;
	...
	float target = Max(linearSlop, totalRadius - 3.0f * linearSlop);
