							...
							const PolygonShape* polygonB, const Transform& xfB)
{
	...
	if (primaryAxis.type == EPAxis::e_edgeA)
	{
		...
		clipPoints[0].id.cf.typeA = ContactFeature::e_face;
		clipPoints[0].id.cf.typeB = ContactFeature::e_vertex;

		clipPoints[1].v = tempPolygonB.vertices[i2];
		clipPoints[1].id.cf.indexA = 0;
		clipPoints[1].id.cf.indexB = static_cast<unsigned char>(i2);
		clipPoints[1].id.cf.typeA = ContactFeature::e_face;
		clipPoints[1].id.cf.typeB = ContactFeature::e_vertex;
	...
	else
	{
		...
		clipPoints[0].id.cf.typeA = ContactFeature::e_vertex;
		clipPoints[0].id.cf.typeB = ContactFeature::e_face;

		clipPoints[1].v = v1;
		clipPoints[1].id.cf.indexA = 0;
		clipPoints[1].id.cf.indexB = static_cast<unsigned char>(primaryAxis.index);		
		clipPoints[1].id.cf.typeA = ContactFeature::e_vertex;
		clipPoints[1].id.cf.typeB = ContactFeature::e_face;
