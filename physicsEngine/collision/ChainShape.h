...
public:
	...
	void CreateLoop(const std::vector<Vec2>& vertices, int count);
	...
	void CreateChain(const std::vector<Vec2>& vertices, int count, const Vec2& prevVertex, const Vec2& nextVertex);
