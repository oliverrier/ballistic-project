...
bool ShapeCast(ShapeCastOutput * output, const ShapeCastInput * input)
{
    ...
    float radiusA = Max(proxyA->m_radius, b2_polygonRadius);
    float radiusB = Max(proxyB->m_radius, b2_polygonRadius);
    ...
    float sigma = Max(b2_polygonRadius, radius - b2_polygonRadius);
