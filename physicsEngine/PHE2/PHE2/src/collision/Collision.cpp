	...
	case Manifold::e_circles:
		{
			...
			if (DistanceSquared(pointA, pointB) > b2_epsilon * b2_epsilon)
			{
...
// quickhull recursion
static b2Hull b2RecurseHull(Vec2 p1, Vec2 p2, Vec2* ps, int count)
{
	b2Hull hull;
	hull.count = 0;
...
b2Hull b2ComputeHull(const Vec2* points, int count)
{
	...
	AABB aabb = { {b2_maxFloat, b2_maxFloat}, {-b2_maxFloat, -b2_maxFloat} };
