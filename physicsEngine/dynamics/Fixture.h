...
public:
	...
	bool RayCast(RayCastOutput* output, const RayCastInput& input, int childIndex) const;
...
inline bool Fixture::RayCast(RayCastOutput* output, const RayCastInput& input, int childIndex) const
{
